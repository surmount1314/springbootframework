...
public class ZKClient implements Watcher {
	...
	// zookeeper服务器地址
	private static final String ZOOKEEPER_ADDRESS = "192.168.56.1:2181";
	...
	public static void main(String[] args) throws InterruptedException {
		...
		if (isSuccess) {
			...
			// 创建子节点
			isSuccess = test.createNode(childrenPath, String.valueOf(System.currentTimeMillis()), Ids.OPEN_ACL_UNSAFE,
		...
		Thread.sleep(1000);
		// 创建临时有序子节点
		test.createNode(childrenPath, String.valueOf(System.currentTimeMillis()), Ids.OPEN_ACL_UNSAFE,
